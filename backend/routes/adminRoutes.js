...
const { getAdminDetails, updateAdminDetails, getWhatsappAdmin,  getAllUsers, getAllEvents, getEventParticipants, getAllBuilders, getDashboardStats, adminUpdateUser, createAdmin, getAllAdmins, deleteAdmin} = require('../controller/adminController');
