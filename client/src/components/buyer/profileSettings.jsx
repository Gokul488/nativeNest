...
const ProfileSettings = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API_BASE_URL}/api/user`, payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group md:col-span-2">
                <label className="block text-sm font-bold text-gray-700 mb-2 group-focus-within:text-teal-600">Full Name</label>
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Leave blank to keep current" className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all outline-none bg-gray-50/30" />
