...
const ManageStallTypes = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col min-h-[600px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-6 py-4 bg-gray-50/50 border-b border-gray-200">
        ...
        {!loading && filteredStallTypes.length > 0 && (
          <>
            ...
            <div className="md:hidden p-4 space-y-4">
              {filteredStallTypes.map((type, index) => (
                <div key={type.stall_type_id} className="bg-gray-50 rounded-xl p-4 border border-gray-100 shadow-sm space-y-3">
                  <div className="flex justify-between items-start border-b border-gray-200 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-bold text-gray-900 truncate max-w-[200px]">{type.stall_type_name}</div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="space-y-1">
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-bold bg-white border border-gray-200 text-gray-700">
                        {type.no_of_stalls} Units
                      </span>
                    </div>
                    <div className="space-y-1">
